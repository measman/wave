        ...
        <div class="col-xs-12">
            <div class="box box-info">
                <div class="col text-right">
                    <button type="button" id="buysell" class="btn btn-success btn-sm">Buy/Sell
                    </button>
                </div>
                </br>
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="trxList" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Currency</th>
                                <th>Rate</th>
        ...
        <form method="post" id="currency_form">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Buy/Sell</h4>
